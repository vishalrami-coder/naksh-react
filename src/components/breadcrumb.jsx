...
function Breadcrumb({BreadcrumbTitle, BreadcrumbActiveTitle}) {
    return (
        <>
            <section
                className="cs_page_heading cs_bg_filed cs_center cs_primary_bg text-center"
                style={{ backgroundImage: "url('https://arkdin-nextjs.vercel.app/assets/img/page_heading_1.jpg')" }}
            >
                <div className="container">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active">{BreadcrumbActiveTitle}</li>
                    </ol>
                </div>
            </section>
        </>
